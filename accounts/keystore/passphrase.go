...
The crypto is documented at https://github.com/EthereumStandard/wiki/wiki/Web3-Secret-Storage-Definition
	...
	if !ks.skipKeyFileVerification {
		...
		if err != nil {
			msg := "An error was encountered when saving and verifying the keystore file. \n" +
				...
				"https://github.com/EthereumStandard/go-ethereum/issues." +
				"The error was : %s"
