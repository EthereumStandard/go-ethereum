...
import (
	...
	"github.com/EthereumStandard/go-ethereum/common/hexutil"
	...
	"github.com/EthereumStandard/go-ethereum/signer/core"
	"github.com/EthereumStandard/go-ethereum/signer/core/apitypes"
	"github.com/EthereumStandard/go-ethereum/signer/fourbyte"
	"github.com/EthereumStandard/go-ethereum/signer/rules"
	"github.com/EthereumStandard/go-ethereum/signer/storage"
...
func checkFile(filename string) error {
	...
	// https://github.com/EthereumStandard/go-ethereum/issues/20123
...
func testExternalUI(api *core.SignerAPI) {
	...
	{ // Sign data test - typed data
		...
		time.Sleep(delay)
		addr, _ := common.NewMixedcaseAddressFromString("0x0011223344556677889900112233445566778899")
		data := `{"types":{"EIP712Domain":[{"name":"name","type":"string"},{"name":"version","type":"string"},{"name":"chainId","type":"uint256"},{"name":"verifyingContract","type":"address"}],"Person":[{"name":"name","type":"string"},{"name":"test","type":"uint8"},{"name":"wallet","type":"address"}],"Mail":[{"name":"from","type":"Person"},{"name":"to","type":"Person"},{"name":"contents","type":"string"}]},"primaryType":"Mail","domain":{"name":"Ether Mail","version":"1","chainId":"4946874","verifyingContract":"0xCCCcccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC"},"message":{"from":{"name":"Cow","test":"3","wallet":"0xcD2a3d9F938E13CD947Ec05AbC7FE734Df8DD826"},"to":{"name":"Bob","wallet":"0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB","test":"2"},"contents":"Hello, Bob!"}}`
